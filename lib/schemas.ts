...
export const loginSchema = z.object({
  ...
  password: z
    ...
    .max(16, {
      message:
        "password must be under 16 characters",
    }),
})
...
export type ItemState =
  (typeof itemStatusOptions)[number]
...
export const ItemFormSchema = z.object({
  ...
  overDeliveryAllowance: z.coerce
    .number()
    .default(0),
  overBillingAllowance: z.coerce
    .number()
    .default(0),
...
export type ItemFormInput = z.infer<
  typeof ItemFormSchema
>
