...
const ForgotPasswordDialog = ({
  ...
  const handleSubmit = async () => {
    ...
    toast.promise(promise, {
      ...
      success: () =>
        "Email sent, check you given email",
    })
  }
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            ...
            secure link to reset your password. If
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            ...
            send you a secure login link. Make
            sure the address is correct before
            continuing, as the link will expire
